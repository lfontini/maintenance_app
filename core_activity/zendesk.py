...
headers = {
    'Authorization': 'Basic bm9jQGlnbmV0d29ya3MuY29tL3Rva2VuOk8yUTdYeGZScUxJOHF2MEF1NGxtSk10NnVEOHhqTU1wdUlrUU96YUI=',  # Replace 'YOUR_API_KEY' with your actual API key
    'Content-Type': 'application/json'  # Fixed the content-type header
}

response = requests.post(url, headers=headers, json=payload)  # Used requests.post instead of requests.request
