...
def generate_notification_template():
    # html template
    '''This function define the html template used to zendesk tickets canceled'''
    template_string = """
<!DOCTYPE html>
<html>
...
def cancel_tickets(tickets):
    ''' this function check the length of tickets and create an update
    
    Obs: for one ticket use https://ignetworks.zendesk.com/api/v2/tickets/
    for many use https://ignetworks.zendesk.com/api/v2/tickets/update_many.json?ids=12345,54321
    '''
