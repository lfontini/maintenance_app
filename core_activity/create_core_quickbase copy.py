        ...
        if activity_related_to == 'internet_service':
            ...
            if core_id:
                if common_fields['affected_services']:
                    ...
                    tickets = generate_tickets_zendesk(common_fields['affected_services'],
                                                       common_fields['start_date'], common_fields['end_date'],
                                                       common_fields['duration'], common_fields['location'])
                    if tickets:
                        email = EmailNotification()
                        email.send_notification(
                            core_id=core_id, tickets=tickets, date=common_fields['start_date'])

                        return {'core_id': core_id, 'tickets': tickets, 'servcies': services}
                else:
                    return None
            return None
