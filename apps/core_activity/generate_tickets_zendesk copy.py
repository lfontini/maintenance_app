...
def prepare_tickets_worker(args):
    ...
    for customer in customers.keys():
        ...
        if customer_raw_data:
            ...
            service = customers[customer][0]
            customer_info = Get_service_info(service_id=service)
...
def generate_tickets_zendesk(services, start_date, end_date, down_time, location, description, prefixes_and_contacts):
